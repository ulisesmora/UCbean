    ...
    <div style={{ minHeight:'100%', paddingBottom: 110 }}>
      ...
      <div style={{ padding:'58px 20px 0' }}>
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
          <div style={{ display:'flex', alignItems:'center', gap:10 }}>
            ...
            <div>
              <div style={{ fontSize:11, fontWeight:700, letterSpacing:'0.18em', textTransform:'uppercase', color:'var(--ink-mute)' }}>Around the Bean</div>
              <div style={{ fontSize:14, fontWeight:800, color:'var(--ink)', marginTop:1 }}>Tue · 7:42 AM</div>
            </div>
          </div>
        ...
        <div style={{ fontSize:24, fontWeight:800, marginTop:16, letterSpacing:'-0.01em' }}>Good morning, Joon <Sakura size={20} color="var(--accent)" /></div>
      </div>
      ...
      <div style={{ padding:'18px 20px 0' }}>
        <div style={{
          ...
          {/* decorative branch */}
          <div style={{ position:'absolute', right:-10, top:-6, opacity:0.35 }}>
            <SakuraBranch width={220} height={90}/>
          </div>
          <div style={{ position:'absolute', right:14, bottom:14, opacity:0.95 }}>
            <Logo size={64} color="rgba(255,255,255,0.95)"/>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding:'24px 20px 0', textAlign:'center', color:'var(--ink-mute)', fontSize:11, display:'flex', flexDirection:'column', alignItems:'center', gap:8 }}>
        <Logo size={36} color="var(--ink-mute)"/>
        <span><span style={{ fontFamily:'"Instrument Serif", serif', fontStyle:'italic', fontSize:14, color:'var(--ink-soft)' }}>around the bean · world</span> · est. 2024 · Vancouver</span>
      </div>
    </div>
  );
}
    ...
    <div style={{ position:'absolute', inset:0, background:'rgba(28,24,20,0.50)', zIndex:100, display:'flex', alignItems:'center', justifyContent:'center', padding:18, backdropFilter:'blur(12px)', WebkitBackdropFilter:'blur(12px)' }}>
      <div style={{ width:'100%', maxWidth:340, animation:'fadeUp .35s ease' }}>
        <Glass strong pad={0} style={{ overflow:'hidden', borderRadius:24 }}>
          <div style={{ padding:'24px 22px 20px', textAlign:'center', background:'linear-gradient(180deg, var(--accent-soft) 0%, transparent 100%)', position:'relative' }}>
            <div style={{ position:'absolute', top:0, left:0, right:0, opacity:0.4 }}>
              <SakuraBranch width={340} height={70} color="var(--accent)" flowerColor="var(--accent-deep)"/>
            </div>
            <div style={{ position:'relative', zIndex:1 }}>
              <Logo size={64} color="var(--accent-deep)"/>
            </div>
      ...
      <div style={{ padding:'8px 20px 0' }}>
        <div style={{
          ...
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
            ...
            <Logo size={44} color="rgba(255,255,255,0.95)"/>
          </div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5, 1fr)', gap:8 }}>
            {Array.from({length:10}).map((_,i) => (
              <div key={i} style={{
                aspectRatio:'1',
                borderRadius:'50%',
                background: i < points ? 'linear-gradient(135deg, var(--accent), var(--accent-deep))' : 'rgba(36,24,32,0.06)',
                color:'#fff',
                display:'flex', alignItems:'center', justifyContent:'center',
                boxShadow: i < points ? '0 4px 10px rgba(185,89,121,0.30)' : 'none',
              }}>{i < points ? <Sakura size={18} color="#fff"/> : null}</div>
            ))}
          </div>
        </Card>
      </div>
...
function AccountScreen({ go, points }) {
  return (
    <div style={{ minHeight:'100%', paddingBottom: 110 }}>
      ...
      {/* Identity card */}
      <div style={{ padding:'4px 20px' }}>
        <Card pad={18} style={{ display:'flex', alignItems:'center', gap:14, position:'relative', overflow:'hidden' }}>
          <div style={{ position:'absolute', right:-18, bottom:-18, opacity:0.10 }}>
            <Logo size={140} color="var(--accent-deep)"/>
          </div>
          <div style={{ width:60, height:60, borderRadius:'50%', background:'linear-gradient(135deg, var(--accent), var(--accent-deep))', color:'#fff', display:'flex', alignItems:'center', justifyContent:'center', fontSize:24, fontWeight:800, boxShadow:'0 8px 18px rgba(185,89,121,0.30)', position:'relative', zIndex:1 }}>JP</div>
          ...
          <Btn size="sm" kind="ghost" style={{ position:'relative', zIndex:1 }}>Edit</Btn>
        </Card>
      </div>
