...
export default function MenuPage() {
  return (
    <>
      {/* On a phone the menu is where people land to order: their usuals
          (it renders nothing when signed out) go first, one tap away. */}
      ...
      <div className="bloom relative overflow-hidden">
        <div className="mx-auto max-w-6xl px-6 py-20 md:py-28">
          ...
          <p className="mb-12 max-w-lg text-[16px] leading-relaxed text-stone2-600">
            Single-origin beans, Korean-inspired drinks, and seasonal specials. Everything is made
            to order.
          </p>
