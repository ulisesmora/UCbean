...
export class ReservationsController {
  ...
  bookTable(@CurrentUser() user: JwtPayloadVo, @Body() dto: TableReservationDto) {
  ...
  myReservations(@CurrentUser() user: JwtPayloadVo) {
    return this.getMyReservations.execute(user.sub);
  }
}
